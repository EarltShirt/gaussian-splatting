...
def DisplayNurb(pNode):
    ...
    DisplayString("    Surface Mode: ", lSurfaceModes[lNurb.GetSurfaceMode().value])
    ...
    DisplayString("    Nurb U Type: ", lNurbTypes[lNurb.GetNurbsUType().value])
    DisplayInt("    U Count: ", lNurb.GetUCount())
    DisplayString("    Nurb V Type: ", lNurbTypes[lNurb.GetNurbsVType().value])
