...
def DisplayGlobalLightSettings(pScene):
    ...
    if(lFogMode == FbxGlobalLightSettings.EFogMode.eLinear):
        DisplayString("Fog Mode: Linear")
    elif(lFogMode == FbxGlobalLightSettings.EFogMode.eExponential):
        DisplayString("Fog Mode: Exponential")
    elif(lFogMode == FbxGlobalLightSettings.EFogMode.eExponentialSquareRoot):
