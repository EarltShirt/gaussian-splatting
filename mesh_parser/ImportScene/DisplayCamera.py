...
def DisplayViewingAreaControls(pCamera):
    ...
    DisplayString("        Aspect Ratio Mode: ", lAspectRatioModes[pCamera.GetAspectRatioMode().value])
...
def DisplayApertureAndFilmControls(pCamera):
    ...
    DisplayString("        Aperture Mode: ", lCameraApertureModes[pCamera.GetApertureMode().value])
