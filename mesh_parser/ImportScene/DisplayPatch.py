...
def DisplayPatch(pNode):
    ...
    DisplayString("    Surface Mode: ", lSurfaceModes[lPatch.GetSurfaceMode().value])
    ...
    DisplayString("    Patch U Type: ", lPatchTypes[lPatch.GetPatchUType().value])
    DisplayInt("    U Count: ", lPatch.GetUCount())
    DisplayString("    Patch V Type: ", lPatchTypes[lPatch.GetPatchVType().value])
