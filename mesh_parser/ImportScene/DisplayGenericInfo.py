...
def DisplayProperties(pObject):
    ...
    while lProperty.IsValid():
        ...
        DisplayBool  ("            Is Animatable: ", lProperty.GetFlag(FbxPropertyFlags.EFlags.eAnimatable))

        if lProperty.GetPropertyDataType().GetType() == EFbxType.eFbxBool:
            lProperty = FbxPropertyBool1(lProperty)
            DisplayBool("            Default Value: ", lProperty.Get())
        elif lProperty.GetPropertyDataType().GetType() == EFbxType.eFbxDouble:
            lProperty = FbxPropertyDouble1(lProperty)
            DisplayDouble("            Default Value: ",lProperty.Get())
        elif lProperty.GetPropertyDataType().GetType() == EFbxType.eFbxDouble4:
        ...
        elif lProperty.GetPropertyDataType().GetType() == EFbxType.eFbxInt:
            lProperty = FbxPropertyInteger1(lProperty)
            DisplayInt("            Default Value: ", lProperty.Get())
        elif lProperty.GetPropertyDataType().GetType() == EFbxType.eFbxDouble3:
        ...
        elif lProperty.GetPropertyDataType().GetType() == EFbxType.eFbxFloat:
            lProperty = FbxPropertyFloat1(lProperty)
            DisplayDouble("            Default Value: ", lProperty.Get())
        elif lProperty.GetPropertyDataType().GetType() == EFbxType.eFbxString:
