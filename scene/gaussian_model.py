...
####################################### MY ADDITIONS ############################################
    ...
    def densify_and_split_groups(self, grads, grad_threshold, scene_extent, N=2):
        ...
        self.densification_postfix_groups(new_xyz, new_features_dc, new_features_rest, new_opacity, new_scaling, new_rotation)
    ...
    def densify_and_clone_groups(self, grads, grad_threshold, scene_extent):
        ...
        self.densification_postfix_groups(new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation)

    def prune_points_groups(self, mask):
        valid_points_mask = ~mask
        optimizable_tensors = self._prune_optimizer_groups(valid_points_mask)
    ...
    def densification_postfix_groups(self, new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation):
        d = {"xyz": new_xyz,
